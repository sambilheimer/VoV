const ancestries = {
    "True-kin": {
      ...
      sentenceTemplate: "You are <a>BODY</a> and <a>FACE</a>, with <a>HAIR</a> hair. You wear <a>ATTIRE</a>. You are part of the <a>CASTE</a> caste. You tend to act <a>DEMEANOR</a>, and your most distinctive feature <a>DISTINCTFEATURE</a>.",
...
sentenceTemplate: "You are <a>BODY</a> and <a>FACE</a>, with <a>HAIR</a> hair. You wear <a>ATTIRE</a>. It is your misfortune to <a>MISFORTUNE</a>. You tend to act <a>DEMEANOR</a>, and your most eccentric feature is <a>ECCENTRICITY</a>.",
    ...
    "Synth": {
      ...
      sentenceTemplate: "You are <a>SIZE</a> Synth with the form of <a>FORM</a> and a head <a>HEAD</a>. You have <a>LIMBS</a> limbs and <a>FINISH</a> finish. You are powered by <a>POWERSOURCE</a>. You were made for <a>MADEFOR</a>, but you realized <a>REALIZED</a>.",
    ...
    "Newbeast": {
      ...
      sentenceTemplate: "You take the form of a <a>FORM</a>. <a>MASK</a>. You take on <a>HUE</a> hue, and your oddity is <a>ODDITY</a>.",
    ...
    "Mycomorph": {
      ...
      sentenceTemplate: "You are <a>COLOR</a>, <a>TEXTURE</a>, and <a>BODY</a>, with <a>HEAD</a> head. Your demeanor is <a>DEMEANOR</a>, and you have the quality of <a>QUALITY</a>. You come from the corpse of <a>CORPSE</a>.",
    ...
    "Faa Nomad": {
      ...
      sentenceTemplate: "You are <a>BODY</a> and <a>BLUE</a> with a <a>FACE</a> face and <a>HAIR</a> hair. Your demeanor is <a>DEMEANOR</a>, and your quirk is <a>QUIRK</a>. The reason you left your clan was due to <a>LEAVECLAN</a>.",
    ...
    "Cacklemaw Exile": {
      ...
      sentenceTemplate: "You are <a>DEMEANOR</a> and your laugh is <a>LAUGH</a>. You have a pelt that is <a>PELT</a> with <a>TEETH</a> teeth, and your attire is <a>ATTIRE</a>. The reason you were exiled was <a>EXILED</a>, and what makes you laugh most is <a>LAUGHMOST</a>.",
    ...
    "Lithling": {
      ...
      sentenceTemplate: "You are a <a>SIZE</a> and <a>BODY</a> Lithling with a <a>HEADCARVING</a> carving upon your head. Your skin is <a>HUE</a>. You are <a>MANNER</a>, and the esoteric subject you devote your life to is <a>STUDY</a>. Your quirk is <a>QUIRK</a>.",
    ...
    "Planeyfolk": {
      ...
      names: ["Clotho", "Atropos", "Osteria", "Vanise", "Whervil", "Laomer", "Foxglory", "Thelik", "Umbrie", "Salter", "Atlassia", "Eukelaris", "Galas", "Tarvi", "Untermance", "Rassias", "Menomeo", "Ithari", "Canetonus", "Trout"],
      traits: {
        ...
        demeanor: ["Anxious", "Arrogant", "Assertive", "Charismatic", "Conceited", "Decadent", "Eloquent", "Extravagant", "Hedonistic", "Impulsive", "Irritable", "Meticulous", "Persistent", "Quiet", "Religious", "Pugnacious", "Scholarly", "Stern", "Unruly", "Volatile"],
        geometry: ["Cast Two Shadows", "Never Cast Shadows", "Move Like Stop-Motion Animation", "Your Face Appears Concave", "Your Face Appears Convex", "You Always Appear in Profile", "You Always Face Away From Observers", "One Limb is Enormously Long", "Viewed From Behind You Have No Skin", "Interiors Are Visible, But Cannot be Touched", "Hands Fractal; Tiny Hands on Ends of Fingers", "You Bleed Gory Cubes", "Your Body is Clearly Hollow", "Eyes Are Holes of Infinite Depth", "Voice Sounds As If You Are Far Away", "You Have No Back, Just Two Identical Fronts", "Head Looks Ten Times Larger Than Body", "Never Seem To Touch Anything", "Multiple Identical Faces", "You Never Match the Ambient Light"],
        howflat: ["your Parents were Planeyfolk", "your Parents were Planeyfolk", "your Parents were Planeyfolk", "your Parents were Planeyfolk", "your Parents were Planeyfolk", "you were Exposed to hypergeometry in utero", "you were Exposed to hypergeometry in utero", "you were Cursed by Quantum Daemon", "you were Cursed by Quantum Daemon", "of a Malfunctioning longjaunt portal", "of a Malfunctioning longjaunt portal", "you Accidentally ate hypergeometric food", "you Accidentally ate hypergeometric food", "a Planeyperson inducted you into their dimension", "a Planeyperson inducted you into their dimension", "you Meditated before a 4D tesseract", "you Meditated before a 4D tesseract", "You were a hypergeometrician, there was an accident", "You were a hypergeometrician, there was an accident", "You were a hypergeometrician, there was an accident"]
      },
      sentenceTemplate: "You are <a>BODY</a> and <a>GEOMETRY</a>, with <a>HAIR</a> hair and a <a>HEAD</a> head. Your attire is <a>ATTIRE</a>. You are <a>DEMEANOR</a>, and you are a Planeyfolk because <a>HOWFLAT</a>.",
